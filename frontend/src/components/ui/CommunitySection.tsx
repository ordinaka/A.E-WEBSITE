...
export default function CommunitySection(){
  return (
    <section className="relative h-fit p-5 bg-transparent text-[var(--text-color)] overflow-hidden flex flex-col items-center">
      {/* Title Section */}
      ...
      <div className="w-full max-w-7xl mt-15 lg:mt-20 flex flex-col items-center">
        ...
        <div className="mt-6 w-full max-w-161.75 px-4">
          <div className="flex flex-col items-stretch gap-3 p-0 sm:h-15 sm:flex-row sm:items-center sm:gap-2.75">
            <div className="flex h-14 w-full items-center gap-3 rounded-[15px] ae-brand-card border border-[var(--ae-border)] px-4 py-2.5 shadow-sm sm:h-15 sm:w-105.25 sm:gap-3.25 sm:px-6.75">
              <input
                type="email"
                placeholder="Enter your email..."
                className="h-6.25 w-full min-w-0 bg-transparent text-base leading-6.25 tracking-[-0.500092px] text-[var(--text-color)] outline-none placeholder:text-gray-400 sm:w-43.75 sm:text-[20.0037px]"
              />
            </div>
