      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <motion.div
            ...
            className="relative w-full max-w-4xl overflow-hidden bg-white shadow-2xl rounded-3xl flex flex-col md:flex-row"
          >
            {/* Close Button */}
            <button
              onClick={handleClose}
            ...
            {/* Image Side */}
            <div className="w-full md:w-1/2 h-[300px] md:h-auto overflow-hidden bg-slate-100">
              <img
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <div className="space-y-6">
                <div>
                  <span className="inline-block px-3 py-1 text-xs font-bold tracking-wider text-[var(--ae-blue)] uppercase bg-blue-50 rounded-full mb-3">
                    Applications Open
                  </span>
                  <h2 className="text-3xl md:text-4xl font-black text-[var(--ae-plum-deep)] leading-tight">
                ...
                <div className="pt-4 flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className="flex-1 ae-brand-button flex items-center justify-center gap-2 py-4 text-white font-bold rounded-xl shadow-lg shadow-[var(--ae-blue)]/20 hover:scale-[1.02] transition-all"
                  >
                    Enquire on WhatsApp
                  </a>
                  <button
                    onClick={handleClose}
                    className="flex-1 px-6 py-4 text-slate-500 font-bold hover:bg-slate-50 rounded-xl transition-colors border border-slate-100"
                  >
                    Later
                  </button>
                </div>
