  ...
  return (
    <section>
      <div className="flex justify-between items-center mb-10">
        <div>
          <h2 className="text-[var(--ae-plum-deep)] text-2xl font-bold">Top Categories</h2>
          ...
          return (
            ...
            >
              ...
              <div className="text-center">
                <h3 className="text-[var(--ae-plum-deep)] font-semibold text-sm group-hover:text-[var(--ae-blue)] transition-colors">{cat.title}</h3>
