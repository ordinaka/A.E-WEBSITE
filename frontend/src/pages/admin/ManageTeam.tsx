...
export default function ManageTeam() {
  ...
  return (
    <div className="pt-24 px-6 min-h-screen bg-[var(--ae-bg)] text-white overflow-hidden relative font-outfit">
              ...
              <AnimatePresence>
                {members.map((member) => (
                  <motion.article
                    ...
                    key={member.id}
                    className={`group bg-white/[0.02] border border-white/[0.08] hover:border-blue-500/30 rounded-2xl p-5 transition-all duration-300 flex flex-col md:flex-row gap-6 items-center justify-between ${editingMemberId === member.id ? 'ring-2 ring-blue-500 ring-offset-2 ring-offset-[var(--ae-bg)]' : ''}`}
                  >
